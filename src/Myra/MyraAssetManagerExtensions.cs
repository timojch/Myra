...
namespace AssetManagementBase
{
	public static class MyraAssetManagerExtensions
	{
        ...
        private static AssetLoader<Stylesheet> _classicStylesheetLoader = (manager, assetName, settings, tag) =>
        {
        ...
        private static AssetLoader<GenericStylesheet> _stylesheetLoader = (manager, assetName, settings, tag) =>
        {
            var xml = manager.ReadAsString(assetName);
            ...
            return GenericStylesheet.LoadFromSource(xml, textureRegionAtlas, fonts);
        };
        ...
        public static Stylesheet LoadClassicStylesheet(this AssetManager assetManager, string assetName) => assetManager.UseLoader(_classicStylesheetLoader, assetName);
        public static GenericStylesheet LoadGenericStylesheet(this AssetManager assetManager, string assetName) => assetManager.UseLoader(_stylesheetLoader, assetName);
    }
}
