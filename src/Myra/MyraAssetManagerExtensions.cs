...
namespace AssetManagementBase
{
	public static class MyraAssetManagerExtensions
	{
        ...
        private static AssetLoader<ClassicStylesheet> _classicStylesheetLoader = (manager, assetName, settings, tag) =>
        {
            ...
            return ClassicStylesheet.LoadFromSource(xml, textureRegionAtlas, fonts);
        };
        ...
        public static ClassicStylesheet LoadClassicStylesheet(this AssetManager assetManager, string assetName) => assetManager.UseLoader(_classicStylesheetLoader, assetName);
