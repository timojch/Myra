...
namespace Myra.Graphics2D.UI.ColorPicker
{
    public partial class ColorPickerPanel
    {
        ...
        {
            get => _colorBackground.Renderable;
            set
            {
                foreach (var image in _userColorBackgrounds)
                {
                    image.Renderable = value;
                }

                _colorBackground.Renderable = value;
            }
        }
        ...
        {
            get => _userColors.SelectionBackground;
            set => _userColors.SelectionBackground = value;
        }

        [Category("Appearance")]
        public IBrush SelectionHoverBackground
        {
            get => _userColors.SelectionHoverBackground;
            set => _userColors.SelectionHoverBackground = value;
        }

        [Category("Appearance")]
        public IImage Wheel
        {
            get => _colorWheel.Renderable;
            set => _colorWheel.Renderable = value;
        }

        [Category("Appearance")]
        public IBrush Gradient
        {
            get => _vPicker.Background;
            set => _vPicker.Background = value;
        }

        [Category("Appearance")]
        public IImage VSPickerKnob
        {
            get => ((Image)_vPicker.ImageButton.Content).Renderable;
            set => ((Image)_vPicker.ImageButton.Content).Renderable = value;
        }
