...
namespace Myra.Graphics2D.UI.Styles
{
    public class ClassicStylesheet
    {
        ...
        private readonly Dictionary<string, ProgressBarStyle> _horizontalProgressBarStyles = new Dictionary<string, ProgressBarStyle>();
        private readonly Dictionary<string, ProgressBarStyle> _verticalProgressBarStyles = new Dictionary<string, ProgressBarStyle>();
        private readonly Dictionary<string, SeparatorStyle> _horizontalSeparatorStyles = new Dictionary<string, SeparatorStyle>();
        private readonly Dictionary<string, SeparatorStyle> _verticalSeparatorStyles = new Dictionary<string, SeparatorStyle>();
        ...
        private readonly Dictionary<string, SplitPaneStyle> _horizontalSplitPaneStyles = new Dictionary<string, SplitPaneStyle>();
        private readonly Dictionary<string, SplitPaneStyle> _verticalSplitPaneStyles = new Dictionary<string, SplitPaneStyle>();
        ...
        private readonly Dictionary<string, FlowContainerStyle> _flowContainerStyles = new Dictionary<string, FlowContainerStyle>();
        ...
        [XmlIgnore]
        public FlowContainerStyle FlowContainerStyle
        {
            get => GetDefaultStyle(_flowContainerStyles);
            set => SetDefaultStyle(_flowContainerStyles, value);
        }
